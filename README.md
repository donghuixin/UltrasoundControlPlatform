...
30. [TI EXT_TRIG確定性重播長窗採集與上位機實現](docs/28_TI_EXT_TRIGGER_REPLAY_CAPTURE_2026-09-06.md)
31. [PW Doppler嚴格處理流程與0819雙接收資料稽核](docs/29_PW_DOPPLER_PROCESSING_PIPELINE_AND_0819_DATA_AUDIT_2026-09-20.md)
...
- TI 2026-08-28附件已在本機私有歸檔並核對雜湊：實際基線NCO約486.145 kHz、64條raw rows重建一條16通道I/Q row，所以60 MSPS下separator輸出cadence為937.5 k complex rows/s；本包不替換HSDC INI。上位機現可計算、逐段提示、保存及校驗TI EXT_TRIG確定性重播分塊，但不會把它標成活體連續錄製。三板系統的最新優先級與逐Gate流程見[更正後總方案](docs/27_AFE58JD48_TSW14J50_TX7316_CORRECTED_ULTRASOUND_TEST_PLAN_2026-08-28.md)。
